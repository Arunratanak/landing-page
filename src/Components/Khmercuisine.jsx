function Khmercuisine ({ image, name, description, price, addToCart, onAddToCart }) {
    return (
        <div className="mx-auto mt-8 flex h-136 w-80 flex-col justify-between rounded-2xl border border-black pb-4 transition-colors duration-100 hover:bg-gray-200">
